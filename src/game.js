...
var animations = {
		debug:[{x: 32,y: 0, width: 63, height: 63}],
        idle: [{x: 0,y: 0, width: 63, height: 63}],
        stay: [{x: 63,y: 0,width: 63, height: 63}],
        picked:[{x: 126, y: 0, width: 63, height: 63}]};
...
function bindRefs() {
	var ref = new Array();
	pf(ref, 0, 0);pf(ref, 1, 0);pf(ref, 2, 0);pf(ref, 3, 0);
	refs.push(ref);

	ref = new Array();
	pf(ref, 0, 0);pf(ref, 0, 1);pf(ref, 0, 2);pf(ref, 0, 3);
	refs.push(ref);
	
	ref = new Array();
	pf(ref, 0, 1);pf(ref, 1, 1);pf(ref, 1, 0);pf(ref, 0, 0);
	refs.push(ref);

	ref = new Array();
	pf(ref, 0, 1);pf(ref, 1, 1);pf(ref, 1, 0);pf(ref, 2, 0);
	refs.push(ref);
		
	ref = new Array();
	pf(ref, 1, 2);pf(ref, 1, 1);pf(ref, 0, 1);pf(ref, 0, 0);
	refs.push(ref);
		
	ref = new Array();
	pf(ref, 2, 1);pf(ref, 1, 1);pf(ref, 1, 0);pf(ref, 0, 0);
	refs.push(ref);
		
	ref = new Array();
	pf(ref, 0, 2);pf(ref, 0, 1);pf(ref, 1, 1);pf(ref, 1, 0);
	refs.push(ref);

	ref = new Array();
	pf(ref, 2, 1);pf(ref, 1, 1);pf(ref, 0, 1);pf(ref, 0, 0);
	refs.push(ref);
		
	ref = new Array();
	pf(ref, 0, 2);pf(ref, 0, 1);pf(ref, 0, 0);pf(ref, 1, 0);
	refs.push(ref);
		
	ref = new Array();
	pf(ref, 1, 2);pf(ref, 0, 2);pf(ref, 0, 1);pf(ref, 0, 0);
	refs.push(ref);
		
	ref = new Array();
	pf(ref, 0, 2);pf(ref, 1, 2);pf(ref, 1, 1);pf(ref, 1, 0);
	refs.push(ref);
		
	ref = new Array();
	pf(ref, 2, 0);pf(ref, 1, 0);pf(ref, 0, 0);pf(ref, 0, 1);
	refs.push(ref);
	
	ref = new Array();
	pf(ref, 1, 2);pf(ref, 1, 1);pf(ref, 1, 0);pf(ref, 0, 0);
	refs.push(ref);
	
	ref = new Array();
	pf(ref, 2, 1);pf(ref, 2, 0);pf(ref, 1, 0);pf(ref, 0, 0);
	refs.push(ref);

	ref = new Array();
	pf(ref, 2, 0);pf(ref, 2, 1);pf(ref, 1, 1);pf(ref, 0, 1);
	refs.push(ref);

	ref = new Array();
	pf(ref, 1, 0);pf(ref, 2, 1);pf(ref, 1, 1);pf(ref, 0, 1);
	refs.push(ref);

	ref = new Array();
	pf(ref, 1, 1);pf(ref, 0, 0);pf(ref, 1, 0);pf(ref, 2, 0);
	refs.push(ref);

	ref = new Array();
	pf(ref, 1, 1);pf(ref, 0, 2);pf(ref, 0, 1);pf(ref, 0, 0);
	refs.push(ref);

	ref = new Array();
	pf(ref, 0, 1);pf(ref, 1, 2);pf(ref, 1, 1);pf(ref, 1, 0);
	refs.push(ref);
	for (a=0;a<2; a++){
